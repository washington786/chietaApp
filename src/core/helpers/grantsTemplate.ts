...
export interface GrantsMgApprovalTemplateParams {
  orgName: string;
  orgTradeName: string;
  sdlNo: string;
  date: string;
...
export const grantsMgApprovalTemplate = (params: GrantsMgApprovalTemplateParams) => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8" />
...
<body>
  <div class="page">
    ...
    <!-- Date and Organisation Info -->
    <div style="text-align: right; margin-bottom: 20px; font-size: 14px;">
      <strong>Date:</strong> ${params.date}
    </div>

    <div style="margin-bottom: 25px; font-size: 14px; gap: 10px; display: flex; flex-direction: column;">
      <p><strong>Organisation Legal Name:</strong> ${params.orgName}</p>
      <p><strong>Organisation Trade Name:</strong> ${params.orgTradeName}</p>
      <p><strong>Organisation SDL Number:</strong> ${params.sdlNo}</p>
    </div>

    <!-- Title -->
    <h2 style="text-align: center; margin-bottom: 25px; font-size: 18px; font-weight: bold; font-family: Arial, sans-serif;">CHIETA SKILLS DEVELOPMENT PARTICIPATION ${params.date_code}</h2>

    <!-- Greeting -->
    <p style="font-weight: bold; margin-bottom: 15px; font-size: 14px;">To Whom It May Concern</p>

    <!-- Body Text -->
    <p class="body-text">
      This serves to inform you that your organisation's ${params.date_code} WorkPlace Skills Plan (WSP) – Annual Training Report (ATR) has been approved by the CHIETA. For the following SDL number:
    </p>

    <p style="margin-bottom: 20px; font-size: 14px; font-weight: bold; font-family: Arial, sans-serif;">
      Organisation SDL Number: ${params.sdlNo}
    </p>

    <p class="body-text">
      Through the submission of your WorkPlace Skills Plan and the Annual Training Report, ${params.orgName} is able to comply with the provisions within the legislation ensuring that their employees develop appropriate skills to become competent, productive and empowered in the workplace. This entitles your organisation with the payment of a Mandatory Grant on condition that your organisation's skills development levy is up to date and payable. You will also be entitled to submit an application for Discretionary Grants in the 2024/2025 financial year.
    </p>

    <p class="body-text">
      This further serves to acknowledge and confirm that in the CHIETA database, ${params.sdfName} is a registered SDF for your organisation.
    </p>

    <p class="body-text">
      Should you have any queries relating to the Mandatory Grants or require support please feel free to contact your nearest regional office.
    </p>

    <!-- Regional Offices for Support -->
    <p style="font-weight: bold; margin-top: 25px; margin-bottom: 10px; font-size: 14px; font-family: Arial, sans-serif;">Regional Offices for support:</p>
    
    <table class="contacts-table" style="margin-bottom: 20px;">
      <thead>
        <tr>
          <th>Region</th>
          <th>Person Responsible</th>
      ...
      <tbody>
        <tr>
          <td>Gauteng and Central</td>
          <td>Brenda Ledwaba</td>
          <td>011 628 7088</td>
          <td>bledwaba@chieta.org.za</td>
        </tr>
        <tr>
          <td>Western Cape/NC</td>
          <td>Faith Gcali</td>
          <td>021 551 1113/4</td>
          <td>fgcali@chieta.org.za</td>
        </tr>
        <tr>
          <td>KZN/EC</td>
          <td>Vanessa Mthembu</td>
          <td>031 368 4040</td>
          <td>vmthembu@chieta.org.za</td>
        </tr>
      </tbody>
    </table>

    <!-- Mandatory Grants Payment Support -->
    <p style="font-weight: bold; margin-top: 20px; margin-bottom: 10px; font-size: 14px; font-family: Arial, sans-serif;">Mandatory Grants Payment support:</p>
    
    <ul style="font-size: 14px; margin-left: 20px; line-height: 1.8;">
      <li>Head Office: Louise Mc Namara – Tel: 011 628 7053, Email: lmcnamara@chieta.org.za</li>
    </ul>

    <!-- Closing -->
    <p style="margin-top: 25px; font-size: 14px;">Yours Sincerely,</p>

    <p style="font-weight: bold; margin-top: 20px; font-size: 14px; font-family: Arial, sans-serif;">CHIETA SKILLS PLANNING UNIT</p>

    <!-- Signature -->
    <div class="signature-section">
      <p style="margin-top: 50px; font-size: 14px;">Princess Gkakane
Executive Manager: Grants, Projects &amp; Regions</p>
    </div>

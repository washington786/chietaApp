    ...
    >
      <RCol style={styles.con}>
        ...
        <RRow style={styles.wrap}>
          ...
          <Text variant='titleMedium' style={[styles.text, styles.appTitle]}>
            {focusArea && focusArea.length > 45 ? focusArea.substring(0, 45) + "..." : focusArea}
          </Text>
        </RRow>
...
const styles = StyleSheet.create({
  ...
  appTitle: { fontSize: 12 },
  statusTxt: { backgroundColor: colors.emerald[100], borderRadius: 5, padding: 4 }
})
